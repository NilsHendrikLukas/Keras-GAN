    ...
    def sample_images(self, epoch):
        ...
        for i in range(r):
            for j in range(c):
                ...
                axs[i,j].axis('off')
                cnt += 1
        fig.savefig("/Keras-GAN/sgan/images/mnist_%d.png" % epoch)
        plt.close()

    def save_model(self):

        def save(model, model_name):
            model_path = "/Keras-GAN/sgan/saved_model/%s.json" % model_name
            weights_path = "/Keras-GAN/sgan/saved_model/%s_weights.hdf5" % model_name
